...
<body id="top">
 ...
 <nav class="product-filter">
  ...
  <section class="products">
     @foreach($products as $product)
       @if($product->product_category == 'HP')
      <div class="product-card">
      <div class="product-image">
         <a href="{{ url('productdescription/' .$product->id)}}"> <img src="{{ $product->product_image }}" > </a>
      </div>
  ...
  <h2>ACERR</h2>
    ...
    <section class = "products">
       @foreach($products as $product)
       @if($product->product_category == 'ACER')
    <div class="product-card">
      <div class="product-image">
         <a href="{{ url('productdescription/' .$product->id)}}">
        <img src="{{ $product->product_image }}" > </a>
      </div>
      <div class="product-info">
        <h5>{{ $product->product_name }}</h5>
        <h6>{{ $product->product_price}}</h6>
 ...
 <nav class="product-filter">
  <h2>LENOVO</h2>
    ...
    <section class = "products">
       @foreach($products as $product)
      @if($product->product_category == 'LENOVO')
    <div class="product-card">
       <div class="product-image">
         <a href="{{ url('productdescription/' .$product->id)}}">
        <img src="{{ $product->product_image }}" > </a>
  ...
  <h2>MACBOOK</h2>
    ...
    <section class = "products">
       @foreach($products as $product)
      @if($product->product_category == 'MACBOOK')
    <div class="product-card">
       <div class="product-image">
         <a href="{{ url('productdescription/' .$product->id)}}">
        <img src="{{ $product->product_image }}" > </a>
